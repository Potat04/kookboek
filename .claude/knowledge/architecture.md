...
`MainActivity` gebruikt `navigation-compose` met vijf bestemmingen: bibliotheek, recept, bewerken,
instellingen en `deleted` (de prullenbak, vanuit de instellingen).
